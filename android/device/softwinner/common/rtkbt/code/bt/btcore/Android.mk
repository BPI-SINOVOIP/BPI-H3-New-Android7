...
LOCAL_C_INCLUDES := $(btcoreCommonIncludes)
LOCAL_SRC_FILES := $(btcoreCommonSrc)
LOCAL_MODULE := libbtcore-host-rtk
LOCAL_MODULE_TAGS := optional
...
LOCAL_MODULE := net_test_btcore-rtk
LOCAL_MODULE_TAGS := tests
LOCAL_SHARED_LIBRARIES := liblog
LOCAL_STATIC_LIBRARIES := libbtcore-rtk libosi-rtk
...
LOCAL_MODULE_TAGS := tests
LOCAL_SHARED_LIBRARIES := liblog
LOCAL_STATIC_LIBRARIES := libbtcore-host-rtk libosi-host-rtk
