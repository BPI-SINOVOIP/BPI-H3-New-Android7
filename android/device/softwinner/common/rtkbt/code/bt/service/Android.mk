...
LOCAL_MODULE := bluetoothtbd-rtk
LOCAL_REQUIRED_MODULES = bluetooth.default
LOCAL_STATIC_LIBRARIES += libbtcore-rtk
...
LOCAL_MODULE := bluetoothtbd-host_test-rtk
...
LOCAL_C_INCLUDES += $(btserviceCommonIncludes)
LOCAL_MODULE_TAGS := debug tests
LOCAL_MODULE := bluetoothtbd_test-rtk
LOCAL_SHARED_LIBRARIES += \
	libbinder \
	libchrome \
	libutils
...
LOCAL_MODULE := libbluetooth-client-rtk
...
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE := bluetooth-cli-rtk
LOCAL_STATIC_LIBRARIES += libbluetooth-client-rtk
LOCAL_SHARED_LIBRARIES += \
	libbinder \
	libchrome \
	libutils
...
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE := bt-example-hr-server-rtk
LOCAL_STATIC_LIBRARIES += libbluetooth-client-rtk
LOCAL_SHARED_LIBRARIES += \
	libbinder \
	libchrome \
