...
LOCAL_MODULE := libosi-rtk
LOCAL_MODULE_TAGS := optional
LOCAL_SHARED_LIBRARIES := libc liblog libchrome
LOCAL_STATIC_LIBRARIES := libbt-protos-rtk
LOCAL_MODULE_CLASS := STATIC_LIBRARIES
...
LOCAL_MODULE := net_test_osi-rtk
LOCAL_MODULE_TAGS := tests
LOCAL_SHARED_LIBRARIES := libc liblog libprotobuf-cpp-full libchrome libcutils
LOCAL_STATIC_LIBRARIES := libosi-rtk libbt-protos-rtk
...
LOCAL_STATIC_LIBRARIES := libosi-host-rtk libbt-protos-rtk
