...
PRODUCT_COPY_FILES += \
	device/softwinner/dolphin-bpi-m2z/configs/camera.cfg:system/etc/camera.cfg \
	device/softwinner/dolphin-bpi-m2z/configs/cameralist.cfg:system/etc/cameralist.cfg \
	device/softwinner/dolphin-bpi-m2z/configs/media_profiles.xml:system/etc/media_profiles.xml
...
$(call inherit-product-if-exists, device/softwinner/dolphin-bpi-m2z/modules/modules.mk)
$(call inherit-product, device/softwinner/dolphin-bpi-m2z/device.mk)
...
PRODUCT_BRAND := BPI
PRODUCT_NAME := dolphin_bpi_m2z
PRODUCT_DEVICE := dolphin-bpi-m2z
PRODUCT_MODEL := BPI M2 Zero
