...
public final class BluetoothPairingRequest extends BroadcastReceiver {
    ...
    private static final String ATION_TO_TVSETTING2_ACTION_PAIRING_REQUEST = "ATION_TO_TVSETTING2_ACTION_PAIRING_REQUEST";

    @Override
    public void onReceive(Context context, Intent intent) {
        String action = intent.getAction();
        Log.d("BluetoothPairingRequest get tvdsetting",ATION_TO_TVSETTING2_ACTION_PAIRING_REQUEST);
        if (action.equals(ATION_TO_TVSETTING2_ACTION_PAIRING_REQUEST)) {
            ...
            //pairingIntent.setFlags(Intent.FLAG_ACTIVITY_MULTIPLE_TASK);
