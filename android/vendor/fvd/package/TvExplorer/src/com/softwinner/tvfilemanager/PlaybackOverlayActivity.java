...
public class PlaybackOverlayActivity extends Activity implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        playbackOverlayFragment = (PlaybackOverlayFragment)getFragmentManager().
...
//        overScan();
     ...
     */
    public void onFragmentPlayPause(LocalVideo video, int position, Boolean playPause) {
        mVideoView.setVideoPath(video.getFile_path());
     ...
     * Implementation of OnPlayPauseClickedListener
     */
    public void onFragmentFfwRwd(LocalVideo video, int position) {
        mVideoView.setVideoPath(video.getFile_path());
    ...
    private void updateMetadata(final LocalVideo video) {
        final MediaMetadata.Builder metadataBuilder = new MediaMetadata.Builder();

        String title = video.getFile_name().replace("_", " -");
...
//                video.get());
        ...
        metadataBuilder.putString(MediaMetadata.METADATA_KEY_ARTIST, video.getFile_name());

        metadataBuilder.putBitmap(MediaMetadata.METADATA_KEY_ART, video.getFile_thumbnail());
