...
public abstract class NtlmMessage implements NtlmFlags {
     ...
     */
    protected static final byte[] NTLMSSP_SIGNATURE = new byte[] {(byte) 'N', (byte) 'T',
            (byte) 'L', (byte) 'M', (byte) 'S', (byte) 'S', (byte) 'P', (byte) 0};
     ...
     * @param value
     *            Indicates whether to set (<code>true</code>) or clear (
     *            <code>false</code>) the specified flag.
     */
