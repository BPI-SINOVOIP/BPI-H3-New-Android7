...
public interface NtlmFlags {
    ...
    /**
     * Specifies that communication across the authenticated channel should
     * carry a digital signature (message integrity).
     */
    public static final int NTLMSSP_NEGOTIATE_SIGN = 0x00000010;

    /**
     * Specifies that communication across the authenticated channel should be
     ...
     * sealing authenticated communication.
     */
    ...
    /**
     * Indicates whether the OEM-formatted domain name in which the client
     * workstation has membership is supplied in the Type-1 message. This is
     * used in the negotation of local authentication.
     */
    public static final int NTLMSSP_NEGOTIATE_OEM_DOMAIN_SUPPLIED = 0x00001000;

    /**
     * Indicates whether the OEM-formatted workstation name is supplied in the
     * Type-1 message. This is used in the negotiation of local authentication.
     */
    public static final int NTLMSSP_NEGOTIATE_OEM_WORKSTATION_SUPPLIED = 0x00002000;

    /**
     * Sent by the server to indicate that the server and client are on the same
     * machine. This implies that the server will include a local security
     * context handle in the Type 2 message, for use in local authentication.
     */
    public static final int NTLMSSP_NEGOTIATE_LOCAL_CALL = 0x00004000;

    /**
     * Indicates that authenticated communication between the client and server
     * should carry a "dummy" digital signature.
     */
    ...
    /**
     * Sent by the server in the Type 2 message to indicate that the target
     * authentication realm is a share (presumably for share-level
     * authentication).
     */
     ...
     * protecting authenticated communications. This refers to a particular
     * session security scheme, and is not related to the use of NTLMv2
     * authentication.
     */
