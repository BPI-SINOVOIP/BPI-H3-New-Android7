...
public class lsarpc {
    ...
    public static class LsarLookupSids extends DcerpcMessage {
        ...
        public LsarLookupSids(rpc.policy_handle handle, LsarSidArray sids,
                LsarRefDomainList domains, LsarTransNameArray names, short level, int count) {
            this.handle = handle;
            this.sids = sids;
    ...
    public static class LsarOpenPolicy2 extends DcerpcMessage {
        ...
        public LsarOpenPolicy2(String system_name, LsarObjectAttributes object_attributes,
                int desired_access, rpc.policy_handle policy_handle) {
