...
public class Lmhosts {
    ...
    /**
     * This is really just for {@link jcifs.UniAddress}. It does not throw an
     * {@link java.net.UnknownHostException} because this is queried frequently
     * and exceptions would be rather costly to throw on a regular basis here.
     */
            ...
            if (line.length() == 0) {
                ...
                if (line.startsWith("#INCLUDE ")) {
                    ...
                    if (alt > 0) {
                        ...
                        /*
                         * An include was loaded successfully. We can skip all
                         * other includes up to the #END_ALTERNATE tag.
                         */
                ...
                addr = new NbtAddress(name, ip, false, NbtAddress.B_NODE, false, false, true, true,
