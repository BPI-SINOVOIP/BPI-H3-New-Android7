 ...
 * requires leaving a 4 byte prefix for the NBT header. IOW you must call write(
 * buf, 4, len ). Calling write( buf, 0, len ) will generate an error.
 */
...
public class NbtSocket extends Socket {
    ...
    public NbtSocket(NbtAddress address, String calledName, int port, InetAddress localAddr,
    ...
    public String toString() {
        return "NbtSocket[addr=" + address + ",port=" + super.getPort() + ",localport="
                + super.getLocalPort() + "]";
    }
    ...
    private void connect() throws IOException {
        ...
        try {
            ...
            SessionServicePacket ssp0 = new SessionRequestPacket(calledName,
                    NbtAddress.localhost.hostName);
