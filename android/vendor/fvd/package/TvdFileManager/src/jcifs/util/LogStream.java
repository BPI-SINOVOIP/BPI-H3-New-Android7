...
/**
 * 0 - nothing 1 - critical [default] 2 - basic info can be logged under load 3
 * - almost everything N - debugging
 */
...
public class LogStream extends PrintStream {
    ...
    /**
     * This must be called before <tt>getInstance</tt> is called or it will have
     * no effect.
     */
