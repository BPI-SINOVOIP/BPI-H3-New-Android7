...
class Trans2QueryPathInformationResponse extends SmbComTransactionResponse {
    ...
    class SmbQueryFileBasicInfo implements Info {
        ...
        public String toString() {
            return new String("SmbQueryFileBasicInfo[" + "createTime=" + new Date(createTime)
    ...
    class SmbQueryFileStandardInfo implements Info {
        ...
        public String toString() {
            return new String("SmbQueryInfoStandard[" + "allocationSize=" + allocationSize
                    + ",endOfFile=" + endOfFile + ",numberOfLinks=" + numberOfLinks
                    + ",deletePending=" + deletePending + ",directory=" + directory + "]");
        }
    }
