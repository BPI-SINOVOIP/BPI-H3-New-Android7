...
/**
 * This InputStream can read bytes from a file on an SMB file server. Offsets
 * are 64 bits.
 */
...
public class SmbFileInputStream extends InputStream {
    ...
    public SmbFileInputStream(String url) throws SmbException, MalformedURLException,
    ...
    public SmbFileInputStream(SmbFile file) throws SmbException, MalformedURLException,
            UnknownHostException {
    ...
    /**
     * This stream class is unbuffered. Therefore this method will always return
     * 0 for streams connected to regular files. However, a stream created from
     * a Named Pipe this method will query the server using a "peek named pipe"
     * operation and return the number of available bytes on the server.
     */
    ...
    /**
     * Skip n bytes of data on this stream. This operation will not result in
     * any IO with the server. Unlink <tt>InputStream</tt> value less than the
     * one provided will not be returned if it exceeds the end of the file (if
