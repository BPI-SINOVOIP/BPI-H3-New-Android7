...
/**
 * This <code>OutputStream</code> can write bytes to a file on an SMB file
 * server.
 */
...
public class SmbFileOutputStream extends OutputStream {
    ...
    public SmbFileOutputStream(String url) throws SmbException, MalformedURLException,
    ...
    public SmbFileOutputStream(SmbFile file) throws SmbException, MalformedURLException,
            UnknownHostException {
        this(file, false);
    }
    ...
    public SmbFileOutputStream(String url, boolean append) throws SmbException,
    ...
    /**
     * Creates an {@link java.io.OutputStream} for writing bytes to a file on an
     * SMB server addressed by the <code>SmbFile</code> parameter. See
     * {@link jcifs.smb.SmbFile} for a detailed description and examples of the
     ...
     * <code>SmbFile.FILE_NO_SHARE</code> is specified the client will have
     * exclusive access to the file. An additional open command from jCIFS or
     * another application will fail with the "file is being accessed by another
     * process" error. The <code>FILE_SHARE_READ</code>,
     ...
     * @param shareAccess
     *            File sharing flag: <code>SmbFile.FILE_NOSHARE</code> or any
     *            combination of <code>SmbFile.FILE_READ</code>,
     *            <code>SmbFile.FILE_WRITE</code>, and
     *            <code>SmbFile.FILE_DELETE</code>
     */

    public SmbFileOutputStream(String url, int shareAccess) throws SmbException,
            MalformedURLException, UnknownHostException {
