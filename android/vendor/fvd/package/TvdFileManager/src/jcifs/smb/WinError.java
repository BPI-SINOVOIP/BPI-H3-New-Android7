...
public interface WinError {
    ...
    static final int[] WINERR_CODES = {ERROR_SUCCESS, ERROR_ACCESS_DENIED, ERROR_REQ_NOT_ACCEP,
            ERROR_BAD_PIPE, ERROR_PIPE_BUSY, ERROR_NO_DATA, ERROR_PIPE_NOT_CONNECTED,
    ...
    static final String[] WINERR_MESSAGES = {
            ...
            "The pipe state is invalid.", "All pipe instances are busy.",
            "The pipe is being closed.", "No process is on the other end of the pipe.",
