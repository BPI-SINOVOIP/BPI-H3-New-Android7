...
public final class BluetoothNameDialogFragment extends DialogFragment implements TextWatcher {
    ...
    final BluetoothAdapter mLocalAdapter;
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        mAlertDialog = new AlertDialog.Builder(getActivity())
                .setTitle(R.string.accessory_rename)
                .setView(createDialogView(deviceName))
                .setPositiveButton(R.string.accessory_rename,
                ...
                .setNegativeButton(R.string.bluetooth_cancel, null)
                .create();
    ...
    private View createDialogView(String deviceName) {
        ...
        mDeviceNameView = (EditText) view.findViewById(R.id.edit_text);
