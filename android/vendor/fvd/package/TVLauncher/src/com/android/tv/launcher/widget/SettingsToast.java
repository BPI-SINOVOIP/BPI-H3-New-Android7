...
package com.android.tv.launcher.widget;
...
public class SettingsToast extends Toast {
	...
	private static final String TAG = "SettingsToast";
    ...
    public SettingsToast(Context context, CharSequence text, String iconUri) {
        ...
        if (mIconView != null && iconUri != null) {
            ...
            bitmapDownloader.getBitmap(new BitmapWorkerOptions.Builder(mContext)
            		.resource(Uri.parse(iconUri))
            		.width(mIconView.getLayoutParams().width)
                    .height(mIconView.getLayoutParams().height)
                    .build(), mBitmapCallBack);
        }
    }
