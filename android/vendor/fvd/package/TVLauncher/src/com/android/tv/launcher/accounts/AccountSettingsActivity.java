...
package com.android.tv.launcher.accounts;
...
import com.android.tv.launcher.widget.BitmapDownloader;
import com.android.tv.launcher.widget.BitmapDownloader.BitmapCallback;
...
public class AccountSettingsActivity extends MenuActivity {
    ...
    protected String getBrowseTitle() {
    	String title = getIntent().getStringExtra(EXTRA_ACCOUNT);
    	Log.e(TAG, "IKE getBrowseTitle title = " + title);
        return title;
    }

    @Override
    protected Drawable getBadgeImage() {
    	Log.e(TAG, "IKE getBadgeImage in");
        return mAccountDrawable;
    }

    @Override
    protected BrowseInfoFactory getBrowseInfoFactory() {
    	Log.e(TAG, "IKE getBrowseInfoFactory in");
    ...
    protected void onCreate(Bundle savedInstanceState) {
    	...
    	Log.e(TAG, "IKE onCreate title="+getIntent().getStringExtra(EXTRA_ACCOUNT));
    ...
    protected void onResume() {
        ...
        Log.e(TAG, "IKE onResume accountName="+accountName);
