...
import com.android.tv.launcher.dialog.Layout.LayoutRow;
...
public abstract class SettingsLayoutActivity extends Activity implements
	...
	private static final String TAG = "SettingsLayoutActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (mSettingsLayoutFragment == null) {
            mSettingsLayoutFragment = new SettingsLayoutFragment.Builder()
                    ...
                    .icon(layout.getIcon())
                    .iconBackgroundColor(Color.TRANSPARENT)//getResources().getColor(R.color.icon_background))
                    .build();
