...
enum ActionType {
     ...
     * Date & Time
     */
    DATE_TIME_OVERVIEW(R.string.system_date_time), //"日期和时间"
    DATE(R.string.system_date), //"日期"
    TIME(R.string.system_time), //"时间"
    DATE_SET_DATE(R.string.system_set_date), //"设置日期"
    TIME_SET_TIME(R.string.system_set_time), //"设置时间"
    TIME_SET_TIME_ZONE(R.string.system_set_time_zone), //"设置时区"
    TIME_CHOOSE_FORMAT(R.string.system_set_time_format), //"使用24小时格式"
    AUTO_DATE_TIME(R.string.system_auto_date_time, R.string.desc_auto_date_time),//自动确定日期和时间,使用网络提供的时间
    /*
     * Location
     */
