...
public class SettingsLayoutFragment extends Fragment implements Layout.LayoutNodeRefreshListener {
	...
	public static final String TAG = "SettingsLayoutFragment";
    ...
    private void performEntryTransition() {
        ...
        final View contentContainerView = dialogView.findViewById(R.id.content_fragment);
                ...
                @Override
                    ...
                    Runnable mEntryAnimationRunnable = new Runnable() {
                        ...
                        public void run() {
                            ...
                            prepareAndAnimateView(contentContainerView,
                                    startDist, false);
