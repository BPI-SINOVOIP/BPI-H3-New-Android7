...
import com.android.tv.launcher.util.TransitionImage;
import com.android.tv.launcher.util.TransitionImageAnimation;
        ...
        twoPane.getViewTreeObserver().addOnGlobalLayoutListener(
            ...
            Runnable mEntryAnimationRunnable = new Runnable() {
                ...
                public void run() {
                    ...
                    View contentFragmentView = activity.findViewById(mContentAreaId);
                    ...
                    prepareAndAnimateView(contentFragmentView, 0,
                            startDist,
                            secondaryDelay, ANIMATE_IN_DURATION,
                            new DecelerateInterpolator(1.0f),
                            false);
