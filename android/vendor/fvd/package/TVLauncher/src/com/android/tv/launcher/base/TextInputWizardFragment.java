...
package com.android.tv.launcher.base;
...
public class TextInputWizardFragment extends Fragment {
    ...
    private static final String TAG = "TextInputWizardFragment";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle icicle) {
        ...
        if (title != null) {
        	Log.d(TAG, "onCreateView show title="+title);
        	...
        	Log.d(TAG, "onCreateView dismiss title="+title);
