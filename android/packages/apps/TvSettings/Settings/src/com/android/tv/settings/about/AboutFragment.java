...
public class AboutFragment extends LeanbackPreferenceFragment implements
    ...
    public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
        ...
        if(Config.getTargetPlatform(Config.TARGET_BOARD_PLATFORM)==Config.PLATFORM_DOLPHIN){
            firmwareVersionPref.setSummary("7.1.2");
        }else{
        ...
        if(Config.getTargetPlatform(Config.TARGET_BOARD_PLATFORM) == Config.PLATFORM_DOLPHIN){
            ...
            if(buildDisplay.contains("7.0")){
                buildDisplay = buildDisplay.replace("7.0","7.1.2");
            }
            buildNumberPref.setSummary(buildDisplay);
        }else{
