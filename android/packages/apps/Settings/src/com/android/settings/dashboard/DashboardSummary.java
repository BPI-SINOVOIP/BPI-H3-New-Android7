...
public class DashboardSummary extends InstrumentedFragment
    ...
    private static final int UPDATE_VIEW_CREATED = 0;
    private static final int UPDATE_CATEGORY_CHANGED = 1;
    ...
    public void onViewCreated(View view, Bundle bundle) {
        ...
        rebuildUI(UPDATE_VIEW_CREATED);
    }

    //state:0 onViewCreated
    //state:1 onCategoriesChanged
    private void rebuildUI(Integer state) {
        if (!isAdded()) {
        ...
        new SuggestionLoader(state).execute();
    }

    @Override
    public void onCategoriesChanged() {
        rebuildUI(UPDATE_CATEGORY_CHANGED);
    }
    ...
    private class SuggestionLoader extends AsyncTask<Void, Void, List<Tile>> {
        Integer mState;
        SuggestionLoader(Integer state){
            mState = state;
        }
        @Override
