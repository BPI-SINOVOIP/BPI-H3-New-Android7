...
RUN_PATH=`pwd`
TARGET_PATH=$RUN_PATH/rsa_key

DM_MERGE=$RUN_PATH/dm_merge
...
openssl rsa -in $TARGET_PATH/rsa_key.pair -text -out $TARGET_PATH/rsa.txt
$RUN_PATH/pem2mincrypt $TARGET_PATH/rsa.pk ${RSA_KEY}
