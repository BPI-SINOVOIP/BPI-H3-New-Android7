...
class Config:
    ...
    P_SOURCE_ANDROID_DIR = BASE_DIR + "android/"
    P_SOURCE_LICHEE_DIR = BASE_DIR + "lichee/"
...
def init():
    ...
    for git in fileinput.input(Config.P_SOURCE_ANDROID_DIR + ".repo/project.list"):
        allgits.append("android/" + git.strip())
    for git in fileinput.input(Config.P_SOURCE_LICHEE_DIR + ".repo/project.list"):
        allgits.append("lichee/" + git.strip())
