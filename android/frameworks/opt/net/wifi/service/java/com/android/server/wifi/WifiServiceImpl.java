...
public class WifiServiceImpl extends IWifiManager.Stub {
    ...
    private boolean mIsScreenOffDisableWifi;
    /**
    ...
    private final BroadcastReceiver mReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (action.equals(Intent.ACTION_SCREEN_ON)) {
                ...
                if (mIsScreenOffDisableWifi && (getWifiEnabledState() == WIFI_STATE_DISABLED)) {//disabled
                    try {
                        setWifiEnabled(true);
                        mIsScreenOffDisableWifi = false;
		    } catch(Exception e) {
			Log.e(TAG, "setWifiEnabled failed");
                ...
                if (getWifiEnabledState() == WIFI_STATE_ENABLED){//enabled
                    try {
                        setWifiEnabled(false);
                        mIsScreenOffDisableWifi = true;
                    } catch(Exception e) {
			Log.e(TAG, "setWifiEnabled failed");
	            };
                }
