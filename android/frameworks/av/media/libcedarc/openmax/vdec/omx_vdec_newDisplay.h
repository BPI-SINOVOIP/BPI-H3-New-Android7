...
#define OMX_VIDEO_DEC_INPUT_BUFFER_SIZE_SECURE (1024*1024) // 1024 kB
...
#define DI_BUFFER_NEED_TOTAL_NUM (DI_BUFFER_NUM_KEEP_IN_OMX + 0)
...
public:
    ...
    OMX_S32     mExtraOutBufferNum;    //need by native window
    ...
    //for drop_b_frame_4k_h3
    OMX_S64          mCurrentDataPts;
    OMX_S64          mLastSYSTime;
    OMX_S64          mBasePTS;
    OMX_S64          mLastPTS;
    OMX_S64          mReferenceTimeGap; //can be reset according to the preformance of video decoder
    OMX_S64          mBaseTimeGap;
    OMX_BOOL       bGetBaseSYSTimeFlag;
