...
typedef struct Mov_Stbl_Context
{
    CDX_U32            va_stsc_size[3];
    CDX_U32            va_stsz_size[3];
    CDX_U32            va_stco_size[3];
    CDX_U32            va_stss_size;
    CDX_U32            va_stts_size[3];
    CDX_S32            va_stsz_sample_size[3];
}Mov_Stbl_Context;
