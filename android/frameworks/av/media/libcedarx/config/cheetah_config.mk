...
CONF_ANDROID_STRICT_COMPATIBLE = no

ifeq ($(CONF_ANDROID_STRICT_COMPATIBLE), yes)
	LOCAL_CFLAGS += -DANDROID_STRICT_COMPATIBLE
endif
...
LOCAL_CFLAGS += -DCONF_MEDIA_BOOST_CPU_MODE=1
##---------------------------------------------------------------------------##
