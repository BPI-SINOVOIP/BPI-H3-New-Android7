...
//
            ...
            if(demux->cacheThreadId != 0) //* cache some data before start player.
            {
                while(1)
                {
                    ...
                    {
                        //* wait for 30ms if no message come.
                        ret = AwMessageQueueTryGetMessage(demux->mq, &msg, 30);
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        while(1)
                        {
                            ...
                            if(ret < 0)
                            {
                                logi("waiting for %d stream buffer.",ePlayerMediaType);
