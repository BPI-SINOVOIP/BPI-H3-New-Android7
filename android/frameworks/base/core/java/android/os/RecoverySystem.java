...
public class RecoverySystem {
    ...
    public static void rebootWipeUserData(Context context, boolean shutdown, String reason)
        ...
        final String localeArg = "--locale=" + Locale.getDefault().toString();
        final String resetArg = "--wipe_data";
        String command = resetArg + "\n" + localeArg;
        bootCommand_leagcy(context,command);
    }
    ...
    public static void rebootSysRecovery(Context context) throws IOException {
        Log.e(TAG,"reboot to sysrecovery!!!");
        PowerManager pm = (PowerManager) context.getSystemService(Context.POWER_SERVICE);
        pm.reboot(PowerManager.REBOOT_SYSRECOVERY);
