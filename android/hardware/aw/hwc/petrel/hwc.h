...
extern int resetDispConfig(int disp, int type, int mode, disp_device_config *out_config);
extern int check4KBan(void);
extern int checkHDMITmdsCharRate(disp_device_config *config, int max_tmds_rate);
