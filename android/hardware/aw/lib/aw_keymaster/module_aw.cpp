...
#include <string.h>
#include <stdint.h>
#include <schw/keymaster_aw.h>
#include <schw/log_aw.h>
...
#ifdef TEE_KEYMASTER
static const char *low_schw_lib = "/system/lib/libaw_tee_schw.so";
#else
static const char *low_schw_lib = "/system/lib/libaw_schw.so";
#endif
...
int aw_schw_req_libsym(const void *handle)
{
    ...
    schw_handle->libreq = dlopen(low_schw_lib, RTLD_NOW);
        ...
        uint8_t** x509_data, size_t* x509_data_length)
{
    ...
    if((key_blob == NULL) || (key_blob_length ==0)){
          ALOGE("Supplied key blob was NULL");
        return -1;
    }
    send_cmd = (aw_keymaster_cmd_t *)malloc(sizeof(aw_keymaster_cmd_t));
