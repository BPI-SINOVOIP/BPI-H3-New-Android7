...
typedef enum {
    DISP_VGA_MOD_640x480P_60HZ = 0x0,
    DISP_VGA_MOD_800x600P_60HZ = 0x1,
    DISP_VGA_MOD_1024x768P_60HZ = 0x2,
    DISP_VGA_MOD_1280x768P_60HZ = 0x3,
    DISP_VGA_MOD_1280x800P_60HZ = 0x4,
    DISP_VGA_MOD_1366x768P_60HZ = 0x5,
    DISP_VGA_MOD_1440x900P_60HZ = 0x6,
    DISP_VGA_MOD_1920x1080P_60HZ = 0x7,
    DISP_VGA_MOD_1920x1200P_60HZ = 0x8,
...
struct disp_capture_fmt {
    disp_pixel_format format;   /* write-back ouput format, doson't support YUV ouput yet */
    disp_rect window;           /* source crop */
    disp_rect crop;             /* output crop */
};

struct disp_capture_buffer {
    int handle;                      /* Unique integer id represent this buffer */
    disp_pixel_format format;        /* write-back ouput format */
    disp_rect window;                /* source crop */
    disp_rect crop;                  /* output crop */
    disp_rectsz size[3];
...
typedef enum {
    ...
    DISP_INIT_MODE_TWO_DIFF_SCREEN_SAME_CONTENTS = 5,
}disp_init_mode;
