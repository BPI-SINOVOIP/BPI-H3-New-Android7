...
LOCAL_MODULE := bluetoothtbd-usb
LOCAL_REQUIRED_MODULES = bluetooth.default
LOCAL_STATIC_LIBRARIES += libbtcore-usb
...
LOCAL_MODULE := bluetoothtbd-host_test-usb
...
LOCAL_C_INCLUDES += $(btserviceCommonIncludes)
LOCAL_MODULE_TAGS := debug tests
LOCAL_MODULE := bluetoothtbd_test-usb
LOCAL_SHARED_LIBRARIES += \
	libbinder \
	libchrome \
	libutils
...
LOCAL_MODULE := libbluetooth-client-usb
...
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE := bluetooth-cli-usb
LOCAL_STATIC_LIBRARIES += libbluetooth-client-usb
LOCAL_SHARED_LIBRARIES += \
	libbinder \
	libchrome \
	libutils
...
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE := bt-example-hr-server-usb
LOCAL_STATIC_LIBRARIES += libbluetooth-client-usb
LOCAL_SHARED_LIBRARIES += \
	libbinder \
	libchrome \
