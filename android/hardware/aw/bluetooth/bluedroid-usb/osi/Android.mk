...
LOCAL_MODULE := libosi-usb
LOCAL_MODULE_TAGS := optional
LOCAL_SHARED_LIBRARIES := libc liblog libchrome
LOCAL_STATIC_LIBRARIES := libbt-protos-usb
LOCAL_MODULE_CLASS := STATIC_LIBRARIES
...
LOCAL_MODULE := net_test_osi-usb
LOCAL_MODULE_TAGS := tests
LOCAL_SHARED_LIBRARIES := libc liblog libprotobuf-cpp-full libchrome libcutils
LOCAL_STATIC_LIBRARIES := libosi-usb libbt-protos-usb
...
LOCAL_STATIC_LIBRARIES := libosi-host-usb libbt-protos-usb
