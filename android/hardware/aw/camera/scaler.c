...
void SC_hor_filter(ISP_CTX *ispctx,
               ...
               int align)
{
    ...
    int vphase,hratio = 1,vratio = 1,init_vphase;
    ...
    for(i=0; i<ispctx->SC_dst_height; i++)
    {
        ...
        else
        {
            ...
            //need to fill
            SC_hor_filter(ispctx,
                          lastline,
                          psrc+base_line*align_width,
                          ispctx->width,
                          ispctx->SC_dst_width,
                          ispctx->SC_luma_hor_ratio,
                          ispctx->SC_luma_hor_init_phase,
                          0);
        }
    ...
    switch(fmt)
    {
    // 0-yuv420, 1-yuv422, 2-yvu420, 3-yvu422,4-yuyv422, 5-32x32,
    // 8-argb8888, 9-rgba8888, 10-abgr8888, 11-bgra8888
    case 0:
    ...
    for(i=0;i<dst_height;i++)
    {
        ...
        else
        {
            ...
            SC_hor_filter(ispctx,
                          lastline,
                          CbPtr+base_line*cro_align_width,
                          src_width,
                          dst_width,
                          hratio,
                          ispctx->SC_chroma_hor_init_phase,
                          0);
        }
        ...
        else
        {
            ...
            SC_hor_filter(ispctx,
                          curline,
                          CbPtr+base_linep1*cro_align_width,
                          src_width,
                          dst_width,
                          hratio,
                          ispctx->SC_chroma_hor_init_phase,
    ...
    for(i=0;i<dst_height;i++)
    {
        ...
        else
        {
            ...
            SC_hor_filter(ispctx,
                          lastline,
                          CrPtr+base_line*cro_align_width,
                          src_width,
                          dst_width,
                          hratio,
                          ispctx->SC_chroma_hor_init_phase,
        ...
        else
        {
            ...
            SC_hor_filter(ispctx,
                          curline,
                          CrPtr+base_linep1*cro_align_width,
                          src_width,
                          dst_width,
                          hratio,
                          ispctx->SC_chroma_hor_init_phase,
