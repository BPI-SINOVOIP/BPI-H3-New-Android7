...
#endif
#if 0
#define Aw_SCHW_Log(x...) KLOG_ERROR("AW_TEE_KM:", x)
#undef ALOGE
#define ALOGE Aw_SCHW_Log

#undef ALOGD
#define ALOGD Aw_SCHW_Log

#undef ALOGI
#define ALOGI Aw_SCHW_Log

#define AW_LOG Aw_SCHW_Log
...
#ifdef AW_TRACE
#define Func_Entry() _Aw_SCHW_Log(AW_LOG_TRACE, AW_LOG_TAG,\
                                  "%s Entry , Line: %d",\
                                  __FUNCTION__, __LINE__)
#define Func_Exit() _Aw_SCHW_Log(AW_LOG_TRACE, AW_LOG_TAG,\
                                 "%s Exit , Line: %d",\
                                 __FUNCTION__, __LINE__)
#else
