...
DRM_API_VOID digit_t DRM_CALL add_same( const digit_t *, const digit_t *, __inout_ecount( lng ) digit_t *, const DRM_DWORD lng );

DRM_API_VOID sdigit_t DRM_CALL add_sub_same( const digit_t *, const digit_t *, const digit_t *,
...
DRM_API digit_t DRM_CALL decumulate( __in_ecount(lng) const digit_t *, __in const digit_t, __inout_ecount(lng) digit_t *, __in const DRM_DWORD lng);
...
DRM_NO_INLINE DRM_API DRM_BOOL DRM_CALL mod_LucasUV
        (const digit_t C1[],
         const digit_t C0[],
         const digit_t exponent[],
         const DRM_DWORD   lngexpon,
...
DRM_API DRM_BOOL DRM_CALL mp_shift( __in_ecount(lng) const digit_t *, const DRM_LONG, __inout_ecount(lng) digit_t *,
                            const DRM_DWORD lng);
...
DRM_API_VOID DRM_VOID DRM_CALL uncreate_modulus(mp_modulus_t*, struct bigctx_t *f_pBigCtx);
