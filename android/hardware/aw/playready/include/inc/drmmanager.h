...
DRM_API_VOID DRM_VOID DRM_CALL Drm_ClearAllCaches();
...
DRM_API DRM_RESULT DRM_CALL Drm_Reader_DecryptOpaque(
    ...
    __in_ecount( f_cEncryptedRegionMappings )       DRM_DWORD                *f_pdwEncryptedRegionMappings,
...
DRM_NO_INLINE DRM_API_VOID DRM_VOID DRM_CALL DRM_Reader_FreeOpaqueDecryptedContent(
    ...
    __inout    DRM_BYTE                *f_pbOpaqueClearContent );
...
DRM_API DRM_RESULT DRM_CALL Drm_Platform_Initialize();

DRM_API DRM_RESULT DRM_CALL Drm_Platform_Uninitialize();
...
DRM_API_VOID DRM_VOID* DRM_CALL Drm_Prnd_MemAlloc(
    __in                                                              DRM_DWORD                                         f_cbToAlloc );

DRM_API_VOID DRM_VOID DRM_CALL Drm_Prnd_MemFree(
    __in_opt                                                          DRM_VOID                                         *f_pvToFree );
...
DRM_NO_INLINE DRM_API DRM_RESULT DRM_CALL Drm_LocalLicense_CreatePlayReadyObject(
    ...
    __in_opt                      const DRM_LICENSE_HANDLE                  *f_pLicenses,
...
DRM_NO_INLINE DRM_API DRM_RESULT DRM_CALL Drm_SecureStop_Initialize(
    ...
    __out                                       DRM_SECURESTOP_CONTEXT     *f_pSecureStop );
...
DRM_NO_INLINE DRM_API DRM_RESULT DRM_CALL Drm_SecureStop_BindDecryptor(
    __in                                        DRM_APP_CONTEXT            *f_pAppContext,
    __inout                                     DRM_SECURESTOP_CONTEXT     *f_pSecureStop,
    __in                                  const DRM_DECRYPT_CONTEXT        *f_pDecryptor );
...
DRM_NO_INLINE DRM_API_VOID DRM_VOID DRM_CALL Drm_SecureStop_Uninitialize(
