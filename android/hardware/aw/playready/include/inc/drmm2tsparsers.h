...
DRM_NO_INLINE DRM_API DRM_RESULT DRM_CALL DRM_M2TS_ParseTSPacketHeader(
...
DRM_NO_INLINE DRM_API DRM_RESULT DRM_CALL DRM_M2TS_SetTSPacketHeader(
...
DRM_NO_INLINE DRM_API DRM_RESULT DRM_CALL DRM_M2TS_ParsePacketHeader(
...
DRM_NO_INLINE DRM_API DRM_RESULT DRM_M2TS_UpdatePESPacketLength(
...
DRM_NO_INLINE DRM_API DRM_RESULT DRM_CALL DRM_M2TS_CheckPESCompleteness(
    __inout                             DRM_M2TS_ENCRYPTOR_CONTEXT              *f_pEncContext,
    __inout                             DRM_M2TS_STREAM                         *f_pStream,
    __out                               DRM_BOOL                                *f_pfPESCompleted ) DRM_NO_INLINE_ATTRIBUTE;

DRM_NO_INLINE DRM_API DRM_RESULT DRM_CALL DRM_M2TS_CheckLastPESContinuityCounter(
    __inout                             DRM_M2TS_STREAM                         *f_pStream ) DRM_NO_INLINE_ATTRIBUTE;


DRM_NO_INLINE DRM_API DRM_RESULT DRM_CALL DRM_M2TS_H264_CreateSubsampleMappings(
    __inout                             DRM_M2TS_ENCRYPTOR_CONTEXT              *f_pEncContext,
    __inout                             DRM_M2TS_SUBSAMPLE_CONTEXT              *f_poSubsampleContext,
    __inout                             DRM_M2TS_PES                            *f_pPES ) DRM_NO_INLINE_ATTRIBUTE;

DRM_NO_INLINE DRM_API DRM_RESULT DRM_CALL DRM_M2TS_MPEG2_VIDEO_CreateSubsampleMappings(
    __inout                             DRM_M2TS_ENCRYPTOR_CONTEXT              *f_pEncContext,
    __inout                             DRM_M2TS_SUBSAMPLE_CONTEXT              *f_poSubsampleContext,
    __inout                             DRM_M2TS_PES                            *f_pPES ) DRM_NO_INLINE_ATTRIBUTE;

DRM_NO_INLINE DRM_API DRM_RESULT DRM_CALL DRM_M2TS_CreateAudioSubsampleMappings(
    __inout                             DRM_M2TS_ENCRYPTOR_CONTEXT              *f_pEncContext,
...
DRM_NO_INLINE DRM_API DRM_RESULT DRM_CALL DRM_M2TS_SyncAndParseMPEGAAudioFrameHeaderCallback(
    __inout                             DRM_M2TS_SUBSAMPLE_CONTEXT              *f_poSubsampleContext,
    __inout                             DRM_WORD                                *f_pwSyncOffset,
    __out                               DRM_BOOL                                *f_pfSynced,
    __out                               DRM_UINT64                              *f_pqwDuration ) DRM_NO_INLINE_ATTRIBUTE;

DRM_NO_INLINE DRM_API DRM_RESULT DRM_CALL DRM_M2TS_SyncAndParseADTSFrameHeaderCallback(
    __inout                             DRM_M2TS_SUBSAMPLE_CONTEXT              *f_poSubsampleContext,
    __inout                             DRM_WORD                                *f_pwSyncOffset,
    __out                               DRM_BOOL                                *f_pfSynced,
    __out                               DRM_UINT64                              *f_pqwDuration ) DRM_NO_INLINE_ATTRIBUTE;

DRM_NO_INLINE DRM_API DRM_RESULT DRM_CALL DRM_M2TS_SyncAndParseDDPlusFrameHeaderCallback(
    __inout                             DRM_M2TS_SUBSAMPLE_CONTEXT              *f_poSubsampleContext,
    __inout                             DRM_WORD                                *f_pwSyncOffset,
    __out                               DRM_BOOL                                *f_pfSynced,
    __out                               DRM_UINT64                              *f_pqwDuration ) DRM_NO_INLINE_ATTRIBUTE;

DRM_NO_INLINE DRM_API DRM_BOOL DRM_CALL DRM_M2TS_HasPayload(
    __in                          const DRM_M2TS_PES                            *f_pPES ) DRM_NO_INLINE_ATTRIBUTE;

DRM_NO_INLINE DRM_API DRM_RESULT DRM_CALL DRM_M2TS_FillSubsampleContextBuffer(
...
DRM_NO_INLINE DRM_API DRM_BOOL DRM_CALL DRM_M2TS_FindVideoStartCode(
