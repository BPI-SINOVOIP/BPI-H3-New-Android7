...
typedef struct __tagDRM_MOVE_INDEX_SIGNATURE
{
    ...
    DRM_XB_BYTEARRAY          xbbaValidatingPubKey;
...
DRM_API DRM_RESULT DRM_CALL DRM_MI_ParseIndex(
    __inout_bcount( f_cbStack )       DRM_BYTE                *f_pbStack,
    __in                              DRM_DWORD                f_cbStack,
    __in_bcount( f_cbIndex )    const DRM_BYTE                *f_pbIndex,
    __in                              DRM_DWORD                f_cbIndex,
    __out                             DRM_MOVE_INDEX          *f_pIndex);

DRM_NO_INLINE DRM_API DRM_RESULT DRM_CALL DRM_MOV_ParseIndex(
    __inout_bcount( f_cbStack )       DRM_BYTE                *f_pbStack,
    __in                              DRM_DWORD                f_cbStack,
    __in_bcount( f_cbIndex )    const DRM_BYTE                *f_pbIndex,
    __in                              DRM_DWORD                f_cbIndex,
    __out                             DRM_MOVE_INDEX          *f_pIndex,
    __inout                           DRM_BYTE                 f_rgbCryptoContext[ DRM_PKCRYPTO_CONTEXT_BUFFER_SIZE ]) DRM_NO_INLINE_ATTRIBUTE;
