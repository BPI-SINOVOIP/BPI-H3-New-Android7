...
DRM_NO_INLINE DRM_API DRM_RESULT DRM_MTR_GetKIDData(
...
DRM_NO_INLINE DRM_API DRM_RESULT DRM_MTR_CreateNewTID(
...
DRM_NO_INLINE DRM_API DRM_RESULT DRM_MTR_ReadTIDFromMeteringStore(
    __in            DRM_METERING_CONTEXT   *f_pmeterstore,
    __in      const DRM_BYTE                f_rgbPasswordSST [ DRM_SHA1_DIGEST_LEN ],
...
PREFAST_PUSH_DISABLE_EXPLAINED(__WARNING_NONCONST_PARAM_25004, "Out params can't be const")
DRM_NO_INLINE DRM_API DRM_RESULT DRM_MTR_WriteTIDToMeteringStore(
    __inout     DRM_METERING_CONTEXT *f_pmeterstore,
    __in  const DRM_BYTE              f_rgbPasswordSST [ DRM_SHA1_DIGEST_LEN ],
    __in  const DRM_MID              *f_pmid,
...
DRM_API DRM_RESULT DRM_CALL DRM_MTR_OpenId(
    ...
    __in_bcount( DRM_SHA1_DIGEST_LEN ) const DRM_BYTE              f_rgbPasswordMTR[ DRM_SHA1_DIGEST_LEN ],
    __in                                     DRM_DST              *f_pDatastore );
PREFAST_POP
PREFAST_POP
...
DRM_API DRM_RESULT DRM_CALL DRM_MTR_CreateMeterStorePassword(
    ...
    __out_bcount( DRM_SHA1_DIGEST_LEN )       DRM_BYTE                f_rgbPasswordSST[ DRM_SHA1_DIGEST_LEN ] );
PREFAST_POP
PREFAST_POP
