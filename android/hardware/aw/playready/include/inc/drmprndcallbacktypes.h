...
typedef struct __tagDRM_PRND_CERTIFICATE_DATA
{
    ...
    DRM_DWORD                       dwPlatformIdentifier;   /* One of many DRM_BCERT_SECURITY_VERSION_PLATFORM_* values.  Refer to drmbcertconstants.h. */
    DRM_DWORD                       dwSecurityLevel;        /* Typically will be one of the DRM_BCERT_SECURITYLEVEL_* constants, e.g. DRM_BCERT_SECURITYLEVEL_150.  Refer to drmbcertconstants.h. */
