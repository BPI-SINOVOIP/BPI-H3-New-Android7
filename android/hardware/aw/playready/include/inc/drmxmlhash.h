...
DRM_API DRM_RESULT DRM_CALL DRM_XMLHASH_Start();

DRM_API DRM_RESULT DRM_CALL DRM_XMLHASH_Stop();

DRM_API DRM_RESULT DRM_CALL DRM_XMLHASH_Init();

DRM_API DRM_RESULT DRM_CALL DRM_XMLHASH_UnInit();

DRM_API DRM_RESULT DRM_CALL DRM_XMLHASH_Cleanup();
