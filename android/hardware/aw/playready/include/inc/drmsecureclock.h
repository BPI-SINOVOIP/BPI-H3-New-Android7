...
DRM_API_VOID DRM_VOID DRM_CALL _PrepareSecureClockDataForWriting( DRM_SECSTORE_CLOCK_DATA *pData );
...
DRM_API DRM_RESULT DRM_CALL DRM_CLK_CreateChallenge(
    ...
    __in                       const DRM_BYTE               rgbSecStoreInPswd [ DRM_SHA1_DIGEST_LEN ],
...
** Returns:     DRM_VOID
***********************************************************************/
DRM_API_VOID DRM_VOID DRM_CALL DRM_LIC_LoadSecureTimeData(
...
DRM_NO_INLINE DRM_API DRM_RESULT DRM_CALL DRM_CLK_VariableSecureTimeGetorSet(
