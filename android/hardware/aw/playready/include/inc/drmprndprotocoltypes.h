...
#define DRM_PRND_SESSION_STACK_SIZE                             20000                   /* ~= 20 KByte */
#define DRM_PRND_XB_STACK_SIZE                                  1000                    /* ~= 1 KByte */
...
typedef struct __tagDRM_PRND_TRANSMITTER_SESSION_CONTEXT
{
    ...
    /* General members */
    DRM_BYTE                                             rgbStack[DRM_PRND_SESSION_STACK_SIZE];
...
DRM_OBFUS_PTR_BTM
    ...
    DRM_GUID                                             guidCurrentLMIDForLicGen;
