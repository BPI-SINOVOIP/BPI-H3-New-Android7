...
DRM_NO_INLINE DRM_API DRM_RESULT DRM_CALL DRM_M2TS_BSR_Init(
...
DRM_NO_INLINE DRM_API DRM_RESULT DRM_CALL DRM_M2TS_BSR_Init_UsePacket(
    __inout                                 DRM_M2TS_BIT_STREAM_CONTEXT         *f_poBSRContext,
    __inout                                 DRM_M2TS_PACKET                     *f_pPacket ) DRM_NO_INLINE_ATTRIBUTE;

DRM_NO_INLINE DRM_API DRM_DWORD DRM_CALL DRM_M2TS_BSR_GetRemainingBytes(
    __inout                                 DRM_M2TS_BIT_STREAM_CONTEXT         *f_poBSRContext ) DRM_NO_INLINE_ATTRIBUTE;

DRM_NO_INLINE DRM_API DRM_RESULT DRM_CALL DRM_M2TS_BSR_SetCounter(
    __inout                                 DRM_M2TS_BIT_STREAM_CONTEXT         *f_poBSRContext,
    __in                              const DRM_DWORD                            f_cbCounter ) DRM_NO_INLINE_ATTRIBUTE;

DRM_NO_INLINE DRM_API DRM_RESULT DRM_CALL DRM_M2TS_BSR_ReadBitsToBYTE(
    __inout                                 DRM_M2TS_BIT_STREAM_CONTEXT         *f_poBSRContext,
    __in                              const DRM_DWORD                            f_cBitsToRead,
    __out_ecount( 1 )                       DRM_BYTE                            *f_pbValue ) DRM_NO_INLINE_ATTRIBUTE;

DRM_NO_INLINE DRM_API DRM_RESULT DRM_CALL DRM_M2TS_BSR_ReadBitsToWORD(
    __inout                                 DRM_M2TS_BIT_STREAM_CONTEXT         *f_poBSRContext,
    __in                              const DRM_DWORD                            f_cBitsToRead,
    __out_ecount( 1 )                       DRM_WORD                            *f_pwValue ) DRM_NO_INLINE_ATTRIBUTE;

DRM_NO_INLINE DRM_API DRM_RESULT DRM_CALL DRM_M2TS_BSR_ReadBitsToDWORD(
    __inout                                 DRM_M2TS_BIT_STREAM_CONTEXT         *f_poBSRContext,
    __in                              const DRM_DWORD                            f_cBitsToRead,
    __out_ecount ( 1 )                      DRM_DWORD                           *f_pdwValue ) DRM_NO_INLINE_ATTRIBUTE;

DRM_NO_INLINE DRM_API DRM_RESULT DRM_CALL DRM_M2TS_BSR_SkipBits(
    __inout                                 DRM_M2TS_BIT_STREAM_CONTEXT         *f_poBSRContext,
...
DRM_NO_INLINE DRM_API DRM_RESULT DRM_CALL DRM_M2TS_BSR_WriteBitsFromBYTE(
    __inout                                 DRM_M2TS_BIT_STREAM_CONTEXT         *f_poBSRContext,
    __in                              const DRM_DWORD                            f_cBitsToWrite,
    __in                                    DRM_BYTE                             f_bValue ) DRM_NO_INLINE_ATTRIBUTE;

DRM_NO_INLINE DRM_API DRM_RESULT DRM_CALL DRM_M2TS_BSR_WriteBitsFromWORD(
    __inout                                 DRM_M2TS_BIT_STREAM_CONTEXT         *f_poBSRContext,
    __in                              const DRM_DWORD                            f_cBitsToWrite,
    __in                              const DRM_WORD                             f_wValue ) DRM_NO_INLINE_ATTRIBUTE;

DRM_NO_INLINE DRM_API DRM_RESULT DRM_CALL DRM_M2TS_BSR_SkipBytes(
    __inout                                 DRM_M2TS_BIT_STREAM_CONTEXT         *f_poBSRContext,
    __in                              const DRM_DWORD                            f_cBytesToSkip ) DRM_NO_INLINE_ATTRIBUTE;

DRM_API DRM_RESULT DRM_CALL DRM_M2TS_BSR_IsEndOfBuffer(
    __inout                                 DRM_M2TS_BIT_STREAM_CONTEXT         *f_poBSRContext,
    __out                                   DRM_BOOL                            *f_pfEndOfBuffer ) DRM_NO_INLINE_ATTRIBUTE;

DRM_NO_INLINE DRM_API DRM_RESULT DRM_CALL DRM_M2TS_BSR_InsertBytes(
    __inout                                 DRM_M2TS_BIT_STREAM_CONTEXT         *f_poBSRContext,
...
DRM_NO_INLINE DRM_API DRM_RESULT DRM_CALL DRM_M2TS_BSR_UpdateCRC(
    __inout                                 DRM_M2TS_BIT_STREAM_CONTEXT         *f_poBSRContext,
    __in                              const DRM_DWORD                            f_cbBytesToCalculate ) DRM_NO_INLINE_ATTRIBUTE;

DRM_NO_INLINE DRM_API DRM_RESULT DRM_CALL DRM_M2TS_BSR_ValidateCRC(
    __inout                                 DRM_M2TS_BIT_STREAM_CONTEXT         *f_poBSRContext,
    __in                              const DRM_DWORD                            f_cbBytesToCalculate ) DRM_NO_INLINE_ATTRIBUTE;
