...
DRM_API DRM_RESULT DRM_CALL DRM_SST_OpenKeyTokens(
    ...
    __in_bcount( DRM_SHA1_DIGEST_LEN ) const DRM_BYTE                rgbPassword [ DRM_SHA1_DIGEST_LEN ],
    __in                                     DRM_DWORD               dwFlags,
...
DRM_API DRM_RESULT DRM_CALL DRM_SST_OpenAndLockSlot(
    ...
    __in_bcount( DRM_SHA1_DIGEST_LEN ) const DRM_BYTE                f_rgbPassword[ DRM_SHA1_DIGEST_LEN ],
