...
DRM_NO_INLINE DRM_API DRM_RESULT DRM_CALL DRM_PRND_Receiver_BeginSession(
    __inout                                                           DRM_PRND_RECEIVER_CONTEXT                        *f_poPrndReceiverContext ) DRM_NO_INLINE_ATTRIBUTE;

DRM_NO_INLINE DRM_API DRM_RESULT DRM_CALL DRM_PRND_Receiver_RegistrationRequest_Generate(
...
DRM_NO_INLINE DRM_API DRM_RESULT DRM_CALL DRM_PRND_Transmitter_BeginSession(
    __inout                                                           DRM_PRND_TRANSMITTER_CONTEXT                     *f_poPrndTransmitterContext ) DRM_NO_INLINE_ATTRIBUTE;

DRM_NO_INLINE DRM_API DRM_RESULT DRM_CALL DRM_PRND_Transmitter_RegistrationRequest_Process(
...
DRM_NO_INLINE DRM_API DRM_RESULT DRM_CALL DRM_PRND_Transmitter_RegistrationResponse_Generate(
    __inout                                                           DRM_PRND_TRANSMITTER_CONTEXT                     *f_poPrndTransmitterContext,
    __in_opt                                                    const DRM_ID                                           *f_pCustomDataTypeID,
    __in_bcount_opt( f_cbCustomData )                           const DRM_BYTE                                         *f_pbCustomData,
    __in                                                              DRM_DWORD                                         f_cbCustomData,
...
DRM_NO_INLINE DRM_API DRM_RESULT DRM_CALL DRM_PRND_Transmitter_RegistrationError_Generate(
...
DRM_NO_INLINE DRM_API DRM_RESULT DRM_CALL DRM_PRND_Receiver_RegistrationResponse_Process(
    __inout                                                           DRM_PRND_RECEIVER_CONTEXT                        *f_poPrndReceiverContext,
...
DRM_NO_INLINE DRM_API DRM_RESULT DRM_CALL DRM_PRND_Receiver_RegistrationError_Process(
    __inout                                                           DRM_PRND_RECEIVER_CONTEXT                        *f_poPrndReceiverContext,
...
DRM_NO_INLINE DRM_API DRM_RESULT DRM_CALL DRM_PRND_Receiver_ProximityDetectionStart_Generate(
    __inout                                                           DRM_PRND_RECEIVER_CONTEXT                        *f_poPrndReceiverContext,
    __in                                                              DRM_DWORD                                         f_dwFlags,
...
DRM_NO_INLINE DRM_API DRM_RESULT DRM_CALL DRM_PRND_Transmitter_ProximityDetectionResult_Generate(
    __inout_opt                                                       DRM_PRND_TRANSMITTER_CONTEXT                     *f_poPrndTransmitterContext,
...
DRM_NO_INLINE DRM_API DRM_RESULT DRM_CALL DRM_PRND_Transmitter_ProximityDetectionStart_Process(
    __inout                                                           DRM_PRND_TRANSMITTER_CONTEXT                     *f_poPrndTransmitterContext,
...
DRM_NO_INLINE DRM_API DRM_RESULT DRM_CALL DRM_PRND_Receiver_ProximityDetectionChallenge_Process(
    __inout                                                           DRM_PRND_RECEIVER_CONTEXT                        *f_poPrndReceiverContext,
...
DRM_NO_INLINE DRM_API DRM_RESULT DRM_CALL DRM_PRND_Transmitter_ProximityDetectionResponse_Process(
    __inout                                                           DRM_PRND_TRANSMITTER_CONTEXT                     *f_poPrndTransmitterContext,
...
DRM_NO_INLINE DRM_API DRM_RESULT DRM_CALL DRM_PRND_Receiver_ProximityDetectionResult_Process(
    __inout                                                           DRM_PRND_RECEIVER_CONTEXT                        *f_poPrndReceiverContext,
...
DRM_NO_INLINE DRM_API DRM_RESULT DRM_CALL DRM_PRND_Receiver_LicenseRequest_Generate(
    __inout                                                           DRM_PRND_RECEIVER_CONTEXT                        *f_poPrndReceiverContext,
...
DRM_NO_INLINE DRM_API DRM_RESULT DRM_CALL DRM_PRND_Transmitter_LicenseRequest_Process(
    __inout                                                           DRM_PRND_TRANSMITTER_CONTEXT                     *f_poPrndTransmitterContext,
...
DRM_NO_INLINE DRM_API DRM_RESULT DRM_CALL DRM_PRND_Transmitter_LicenseTransmit_Generate(
    __inout                                                           DRM_PRND_TRANSMITTER_CONTEXT                     *f_poPrndTransmitterContext,
...
DRM_NO_INLINE DRM_API DRM_RESULT DRM_CALL DRM_PRND_Transmitter_ClearPRNDStore(
    __inout                                                           DRM_PRND_TRANSMITTER_CONTEXT                     *f_poPrndTransmitterContext ) DRM_NO_INLINE_ATTRIBUTE;

DRM_NO_INLINE DRM_API DRM_RESULT DRM_CALL DRM_PRND_Receiver_LicenseTransmit_Process(
    __inout                                                           DRM_PRND_RECEIVER_CONTEXT                        *f_poPrndReceiverContext,
...
DRM_NO_INLINE DRM_API DRM_RESULT DRM_CALL DRM_PRND_Receiver_LicenseError_Process(
    __inout                                                           DRM_PRND_RECEIVER_CONTEXT                        *f_poPrndReceiverContext,
    __in_bcount( f_cbErrMessage )                               const DRM_BYTE                                         *f_pbErrMessage,
    __in                                                              DRM_DWORD                                         f_cbErrMessage,
    __out                                                             DRM_RESULT                                       *f_pdrResult,
...
DRM_NO_INLINE DRM_API DRM_RESULT DRM_CALL DRM_PRND_Transmitter_LicenseError_Generate(
    __inout_opt                                                       DRM_PRND_TRANSMITTER_CONTEXT                     *f_poPrndTransmitterContext,
    __in_opt                                                    const DRM_ID                                           *f_pSessionID,
    __in                                                              DRM_DWORD                                         f_dwFlags,
    __deref_out_ecount( *f_pcbErrMessage )                            DRM_BYTE                                        **f_ppbErrMessage,
...
DRM_NO_INLINE DRM_API DRM_RESULT DRM_CALL DRM_PRND_Transmitter_EndSession(
    __inout                                                           DRM_PRND_TRANSMITTER_CONTEXT                     *f_poPrndTransmitterContext ) DRM_NO_INLINE_ATTRIBUTE;

DRM_NO_INLINE DRM_API DRM_RESULT DRM_CALL DRM_PRND_Receiver_EndSession(
    __inout                                                           DRM_PRND_RECEIVER_CONTEXT                        *f_poPrndReceiverContext ) DRM_NO_INLINE_ATTRIBUTE;

DRM_NO_INLINE DRM_API DRM_RESULT DRM_CALL DRM_PRND_Transmitter_IsSessionStillValid(
    __inout                                                           DRM_PRND_TRANSMITTER_CONTEXT                     *f_poPrndTransmitterContext,
    __out                                                             DRM_BOOL                                         *f_pfSessionStillValid ) DRM_NO_INLINE_ATTRIBUTE;

DRM_NO_INLINE DRM_API_VOID DRM_VOID DRM_CALL DRM_PRND_Tx_SafeReleaseKey(
    __inout_ecount( 1 )                               DRM_SECURECORE_CONTEXT          *f_pSecureCoreCtx,
    __inout_ecount( 1 )                               OEM_CRYPTO_HANDLE               *f_phKey ) DRM_NO_INLINE_ATTRIBUTE;

DRM_NO_INLINE DRM_API DRM_RESULT DRM_CALL DRM_PRND_Tx_RebindLicenseKeysToNewECCKey(
    __inout_ecount( 1 )                               DRM_SECURECORE_CONTEXT               *f_pSecureCoreCtx,
    ...
    __inout                                           DRM_DST                              *f_pHDS ) DRM_NO_INLINE_ATTRIBUTE;

DRM_NO_INLINE DRM_API DRM_RESULT DRM_CALL DRM_PRND_Tx_SignWithAESOMAC(
...
DRM_NO_INLINE DRM_API DRM_RESULT DRM_CALL DRM_PRND_OpenPRNDStore(
    ...
    __in_ecount( f_cbPRNDStore )                      const DRM_BYTE                                         *f_pbPRNDStore,
    __in                                                    DRM_DWORD                                         f_cbPRNDStore,
    __out                                                   DRM_BOOL                                         *f_pfOpened ) DRM_NO_INLINE_ATTRIBUTE;

DRM_NO_INLINE DRM_API_VOID DRM_VOID DRM_CALL DRM_PRND_ClosePRNDStore(
    __inout_ecount( 1 )                                     DRM_LICSTORE_CONTEXT                             *f_poLSTContextPRNDStore,
    __inout_ecount( 1 )                                     DRM_DST                                          *f_poDSTContextPRNDStore,
    __inout_ecount( 1 )                                     DRM_EST_CONTEXT                                  *f_poESTContextPRNDStore,
